...
function App() {
  ...
  return html`<div class=${'shell' + (nav.pinned ? ' nav-pinned' : '')} style=${`--nav-width:${nav.width}px`}>
    ...
    <main class=${'main' + (leadRoute ? ' lead-page-main' : clientRoute ? ' client-page-main' : current.id === 'atendimento' ? ' atendimento-page-main' : view === 'marketing/paginas' ? ' marketing-pages-main' : '')}>
